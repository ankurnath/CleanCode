...
if __name__ == "__main__":
    ...
    _,_,solution= knapsack_numba_greedy(graph=train_graph,budget=args.budget,node_weights=node_weights)
    ...
    save_folder =  os.path.join(current_folder,'MaxCover',f'data/{dataset}/Knapsack_GNN') 
