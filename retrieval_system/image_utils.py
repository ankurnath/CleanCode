...
def QS(candidate_similarity, query_similarity,min_budget=5,max_budget=20, delta=0.05,eps=0.1,eta=0.5):
    N = len(candidate_similarity)
    ground_set = np.zeros(N)
    ...
    for i in range(low,high+1):
        ...
        ground_set_single = QS_single(candidate_similarity, query_similarity, delta=delta, budget=tau,eps=eps)
